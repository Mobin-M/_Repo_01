...
def dtfs(N, x_sum, fs):     #note: fs is not necessary for calculating dtfs. just input for the last part printing c.t frequency
    ...
    for k in range(N):
        ...
        res[k] = sum(basis * x_sum)/N   #returns an array of complex number indicatinf magnitude and phase for specific inverstigated frequency (k)
